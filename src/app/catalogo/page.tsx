      ...
      <div className="w-full max-w-2xl p-8 rounded-2xl">
        ...
        <div className="mb-8 flex justify-center">
          <a
            ...
            className="bg-[#D32F2F]/90 text-[#FFFFFF] py-4 px-8 rounded-full transition-all duration-300 transform hover:scale-[1.02] font-semibold text-lg shadow-lg flex items-center justify-center gap-2"
          >
            Download Catalogue
          </a>
        </div>
